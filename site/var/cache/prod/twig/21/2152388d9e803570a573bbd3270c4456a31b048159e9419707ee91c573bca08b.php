...
class __TwigTemplate_26593879babcfd270e0e1a2acc4d782ec233efda7aecd388e759eb194d0bbdd2 extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
    ...
    public function block_shop_group_item($context, array $blocks = [])
    {
        ...
        if ((($context["isGroupContext"] ?? null) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["currentContext"] ?? null), "id", [], "any", false, false, false, 89), twig_get_attribute($this->env, $this->source, ($context["group"] ?? null), "id", [], "any", false, false, false, 89))))) {
    ...
    public function block_shop_item($context, array $blocks = [])
    {
        ...
        // line 101
        if ((($context["isShopContext"] ?? null) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["currentContext"] ?? null), "id", [], "any", false, false, false, 101), twig_get_attribute($this->env, $this->source, ($context["shop"] ?? null), "id", [], "any", false, false, false, 101))))) {
            echo " multishop-modal-color-check";
        }
        echo "\">
                        <i class=\"material-icons\">check</i>
        ...
        // line 105
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["shop"] ?? null), "hasMainUrl", [], "method", false, false, false, 105), false))) {
