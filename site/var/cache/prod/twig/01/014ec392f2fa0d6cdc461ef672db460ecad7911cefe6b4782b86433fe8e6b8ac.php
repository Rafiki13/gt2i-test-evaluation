...
class __TwigTemplate_efc5f96d1d936236c9c9d869ef4c1281f9d3a6526469672198fe646ab6829aae extends Template
{
    private $source;
    private $macros = [];
...
$context["child"], "vars", [], "any", false, false, false, 36), "label", [], "any", false, false, false, 36))) {
    ...
    ";
      ...
      <div class=\"row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
            ...
            // line 67
            echo "                ";
            if (((0 !== twig_compare(($context["childType"] ?? null), "hidden")) ||  !twig_test_empty(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["child"], "vars", [], "any", false, false, false, 67), "label", [], "any", false, false, false, 67)))) {
                // line 68
                echo "                  <th>";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Sell/Catalog/Product/FormTheme/product_suppliers.html.twig", "/var/www/html/src/PrestaShopBundle/Resources/views/Admin/Sell/Catalog/Product/FormTheme/product_suppliers.html.twig");
    }
}
