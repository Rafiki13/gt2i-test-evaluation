...
class __TwigTemplate_fbb569877a3ac1d7a521674b5ef4e25fa907095bcabb052ab6a33b40a4661e52 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div>
      <select name=\"paginator-limit\" id=\"paginator-limit\" class=\"pagination-link custom-select\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["limitChoice"]) {
            ...
            echo "\" ";
            if ((0 === twig_compare(($context["limit"] ?? null), $context["limitChoice"]))) {
                echo "selected=\"selected\"";
            }
            echo ">";
            echo twig_escape_filter($this->env, $context["limitChoice"], "html", null, true);
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Common/javascript_pagination.html.twig", "/var/www/html/src/PrestaShopBundle/Resources/views/Admin/Common/javascript_pagination.html.twig");
    }
}
