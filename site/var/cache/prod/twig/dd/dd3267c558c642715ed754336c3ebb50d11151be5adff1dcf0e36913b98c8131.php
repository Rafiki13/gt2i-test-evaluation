...
class __TwigTemplate_18a421b6f941896a0549c6ae0d7e41d4622fba214cd420af891f649133f19d6f extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        if (($context["stockEnabled"] ?? null)) {
            ...
            // line 72
            echo "      ";
            if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["productData"] ?? null), "header", [], "any", false, false, false, 72), "type", [], "any", false, false, false, 72), "combinations"))) {
                // line 73
                echo "        ";
      ...
      ";
            // line 82
            if ((0 >= twig_compare(($context["quantityData"] ?? null), 0))) {
                // line 83
                echo "        ";
                ...
                // line 85
                echo "      ";
            } elseif (((1 === twig_compare(($context["lowStock"] ?? null), 0)) && (0 >= twig_compare(($context["quantityData"] ?? null), ($context["lowStock"] ?? null))))) {
                // line 86
                echo "        ";
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Sell/Catalog/Product/Blocks/header-details.html.twig", "/var/www/html/src/PrestaShopBundle/Resources/views/Admin/Sell/Catalog/Product/Blocks/header-details.html.twig");
    }
}
