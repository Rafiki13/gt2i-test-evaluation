...
class __TwigTemplate_7818480083e80f95bd2aee22b8bf5020088708541f00c34462dea217f94750fc extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"card-body\">
      <div class=\"form-wrapper\">
        ...
        // line 38
        if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["emailConfigurationForm"] ?? null), "mail_method", [], "any", false, false, false, 38), "vars", [], "any", false, false, false, 38), "value", [], "any", false, false, false, 38), ($context["smtpMailMethod"] ?? null)))) {
            echo " d-none";
        }
        echo "\">
          ";
        ...
        // line 52
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["emailConfigurationForm"] ?? null), "dkim_enable", [], "any", false, false, false, 52), "vars", [], "any", false, false, false, 52), "value", [], "any", false, false, false, 52), 0))) {
            echo " d-none";
        }
        echo "\">
          ";
