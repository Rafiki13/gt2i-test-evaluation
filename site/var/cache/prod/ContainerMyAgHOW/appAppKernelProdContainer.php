...
class appAppKernelProdContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => 'gt2i-mysql', 'port' => '', 'dbname' => 'prestashop', 'user' => 'root', 'password' => 'admin', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('hoPj8vMGxVfmK3P5FGQ6EquwRbXDiMDaiYZtHxSsoE4EaCTAAHv5J7phu5qZoeZo'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'secret' => 'hoPj8vMGxVfmK3P5FGQ6EquwRbXDiMDaiYZtHxSsoE4EaCTAAHv5J7phu5qZoeZo',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2023-08-17',
            'locale' => 'fr-FR',
            'use_debug_toolbar' => true,
            'cookie_key' => 'CFoq1ZDIW3PIzKx8pJ1a7y6hEpRjJGOJMVJskS6EfaFsLDT8D12A78dkFVudSgvs',
            'cookie_iv' => '82PpUS9k94hCsREPHwMNvJLfIKYinyWy',
            'new_cookie_key' => 'def00000dcd8c1aa7fc30286d87e4fa27204e3bf67464f3adc705c273aff37dc3c7e8bb5f161e1cc8fa810b16090ec2783c2c7a1f60cd13813bf84cf03d2809258b87aa1',
            'api_public_key' => '-----BEGIN PUBLIC KEY-----'."\n".'MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAv7EeCUi3IEdRAbwlXtzF'."\n".'Yf2dQqlZTkLC3pjSHph56W4kYGemrtGATtdsbXAaMMNXKms2JnDp3I+l6yF4FXYd'."\n".'JV4jCQ3TsNHAfQnxropSDsJRcxLIEMUAuIfs85ZpF3jXR6st24bj7oSfkZIlAZgn'."\n".'Tvfc34WDIpDOArgpt4n6oGm14KmmjHd2IFAk3K4spRME1BpbiF0H4OtgRD9Sa78P'."\n".'/QGsvmuqBsOm8FI8DtND+/e9+6xb/fIVY2A+xJnxcKV9HFzv74/+CiwMNQG2A/pO'."\n".'xhbmreK+51G8zApxMDSpPVQtxOp0pPFULlO/kriIxs98QbJSwC6q4FZKfZeNJX8p'."\n".'zQIDAQAB'."\n".'-----END PUBLIC KEY-----'."\n".'',
            ...
            'kernel.secret' => 'hoPj8vMGxVfmK3P5FGQ6EquwRbXDiMDaiYZtHxSsoE4EaCTAAHv5J7phu5qZoeZo',
